                                ...
                                <div className='flex flex-col space-y-2 items-center sm:items-start'>
                                    <Dialog>
                                        <DialogTrigger asChild>
                                            <Button variant="ghost" className='gap-1.5 justify-end text-gray-700 mt-2'>
                                        ...
                                        <DialogContent className="lg:max-w-[1000px] sm:max-w-[650px] max-h-[80vh] overflow-y-auto">
                                            <DialogHeader>
                                                <DialogTitle>Cláusulas de Uso y Políticas</DialogTitle>
                                                <DialogDescription>
                                            ...
                                            <div className="grid gap-1.5 py-1.5 text-sm">
                                                <div><strong>Política de Uso y Privacidad de Datos.</strong></div>
                                                <div>En Chizu, respetamos su privacidad y nos comprometemos a protegerla mediante el cumplimiento de esta política.
                                                ...
                                                <div><strong>Política de procesamiento de Pagos.</strong></div>
                                                <div>
                                                ...
                                                <div><strong>Cláusulas de uso.</strong></div>
                                                <div>El usuario debe cumplir con todas las políticas, leyes y regulaciones aplicables al uso de Chizu. En caso que el usuario decida publicar un juego o campaña en Chizu, el usuario debe publicar exclusivamente contenidos de carácter legal y ético. Esto implica, y no se limita, a cumplir con leyes de protección de datos, propiedad intelectual y derechos de autor, no compartir contenido ilegal, ofensivo o cualquier otra normativa relevante. El usuario es responsable del contenido que publique a través de Chizu.
                                            ...
                                            <DialogFooter>
                                                <div className='text-sm text-semibold text-gray-700'>
                                                    Al registrar una nueva cuenta, usted acepta nuestros términos y condiciones.
                                                </div>
                                            </DialogFooter>
                                        </DialogContent>
                                    </Dialog>
